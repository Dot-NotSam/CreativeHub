...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    company: "Ubisoft",
    avatar: "https://images.unsplash.com/photo-1500048993953-d23a436266cf?w=400&h=400&fit=crop&q=80",
    banner: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&h=400&fit=crop&q=80",
    bio: "Sculpting immersive gaming worlds and hyper-realistic assets. Ex-EA Games.",
    location: "Montreal, Canada",
    skills: ["Unreal Engine", "ZBrush", "Substance Painter", "Maya", "3D Modeling"],
    connectionsCount: 710,
    portfolioViews: 14200,
    aboutMe: "I build highly detailed environments and assets for AAA games, focusing on texture fidelity and cinematic lighting setups.",
    experience: [],
    socials: {}
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=1200&h=400&fit=crop&q=80",
    bio: "Shaping visual languages and strategy for global brands.",
    location: "Mumbai, India",
    skills: ["Creative Strategy", "Art Direction", "Brand Identity", "Design Leadership"],
    connectionsCount: 3120,
    portfolioViews: 54900,
    aboutMe: "Creative Director with 12+ years of experience leading cross-functional teams to deliver iconic, cross-platform brand experiences.",
    experience: [],
    socials: {}
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&h=400&fit=crop&q=80",
    bio: "Uncovering user insights to design intuitive streaming services.",
    location: "Stockholm, Sweden",
    skills: ["User Interviews", "Usability Testing", "Data Analysis", "Journey Mapping"],
    connectionsCount: 940,
    portfolioViews: 11000,
    aboutMe: "Passionate about qualitative research and translating human behavior into actionable design opportunities.",
    experience: [],
    socials: {}
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&h=400&fit=crop&q=80",
    bio: "Crafting atmospheric audio designs and modular synth scores. Ableton certified.",
    location: "Dublin, Ireland",
    skills: ["Ableton Live", "Audio Editing", "Synthesis", "Sound FX", "Foley Art"],
    connectionsCount: 840,
    portfolioViews: 9200,
    aboutMe: "Designing sonic experiences for films, interactive web modules, and game soundtracks.",
    experience: [],
    socials: {}
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?w=1200&h=400&fit=crop&q=80",
    bio: "Lively vector scenes, neon palettes, and bold character designs.",
    location: "Singapore",
    skills: ["Vector Illustration", "Procreate", "Editorial Illustration", "Branding"],
    connectionsCount: 530,
    portfolioViews: 7100,
    aboutMe: "Freelance illustrator creating colorful graphic artwork for magazines, packaging, and digital platforms.",
    experience: [],
    socials: {}
  },
  {
    ...
    username: "sofiar",
    role: "Brand & Type Designer",
    company: "Pentagram",
    avatar: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=400&fit=crop&q=80",
    banner: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&h=400&fit=crop&q=80",
    bio: "Drawing custom typefaces and defining typographic design grids.",
    location: "Madrid, Spain",
    skills: ["Typography", "Type Design", "InDesign", "Editorial Design"],
    connectionsCount: 1150,
    portfolioViews: 19800,
    aboutMe: "Specialized in editorial layouts, type design, and high-end visual systems for cultural institutions.",
    experience: [],
    socials: {}
  },
  {
    ...
    name: "Kenji Sato",
    username: "kenjisato",
    role: "Web3 Creative Dev",
    company: "Vercel",
    avatar: "https://images.unsplash.com/photo-1513956589380-bad6acb9b9d4?w=400&h=400&fit=crop&q=80",
    banner: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&h=400&fit=crop&q=80",
    bio: "Pushing the limits of web animations and headless e-commerce.",
    location: "Tokyo, Japan",
    skills: ["Next.js", "GSAP", "React", "NodeJS", "Animation Optimization"],
    connectionsCount: 1720,
    portfolioViews: 32000,
    aboutMe: "Frontend engineer building immersive 3D ecommerce stores and fast web frameworks at Vercel.",
    experience: [],
    socials: {}
  },
  {
    ...
    name: "Aisha Diallo",
    username: "aishad",
    role: "Motion & VFX Artist",
    company: "Weta Digital",
    avatar: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&h=400&fit=crop&q=80",
    banner: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=1200&h=400&fit=crop&q=80",
    bio: "Simulating dynamic particle systems and VFX loops for movies.",
    location: "London, UK",
    skills: ["Houdini", "After Effects", "VFX Simulation", "Particle Shading"],
    connectionsCount: 1250,
    portfolioViews: 22400,
    aboutMe: "Special effects generalist working on cinematic sequences, liquid rendering, and particle dynamics.",
    experience: [],
    socials: {}
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&h=400&fit=crop&q=80",
    bio: "Designing clean checkout experiences and user payment flows.",
    location: "Seattle, WA",
    skills: ["Figma", "UX Design", "Interaction Design", "Prototyping"],
    connectionsCount: 1390,
    portfolioViews: 25400,
    aboutMe: "UX designer passionate about interface simplicity, accessibility, and clear typography in transaction flows.",
    experience: [],
    socials: {}
  }
];
...
export const mockFeedPosts: FeedPost[] = [
  ...
  },
  {
    id: "post-5",
    authorId: "user-4",
    content: "Just completed the label illustrations for 'Botanical Spirits' craft gin bottles. Really loved working on the botanical elements and floral details for this brand campaign!",
    mediaUrl: "https://images.unsplash.com/photo-1527061011665-3652c757a4d4?w=800&auto=format&fit=crop&q=80",
    type: "project_share",
    projectId: "proj-4",
    likes: 98,
    commentsCount: 11,
  ...
  },
  {
    id: "post-6",
    authorId: "user-8",
    content: "Sharing my recent research findings on user interactions with dynamic playlist cards. We saw a 14% uplift in clickthrough rate when custom hover states were active!",
  ...
  },
  {
    id: "post-7",
    authorId: "user-6",
    content: "Working on a medieval ruin scene in Unreal Engine 5. Playing with Nanite and Lumen for global illumination. Rendered in real-time.",
  ...
  },
  {
    id: "post-8",
    authorId: "user-12",
    content: "Experimenting with CSS Grid subgrids and nested interactive layout cards. Code snippet available soon on my GitHub profile.",
  ...
  },
  {
    id: "post-9",
    authorId: "user-14",
    content: "What are your go-to tips for conducting remote usability testing? Currently restructuring our design system feedback loop and looking for ways to streamline user surveys.",
    type: "text",
    likes: 52,
    commentsCount: 18,
    likedByMe: false,
  ...
  },
  {
    id: "post-10",
    authorId: "user-7",
    content: "Just finished a lighting exploration inside Blender. Trying to mimic natural morning light through a frosted glass window. Raytracing makes a huge difference here. Thoughts?",
    type: "text",
    likes: 74,
    commentsCount: 8,
    likedByMe: false,
  ...
  },
  {
    id: "post-11",
    authorId: "user-9",
    content: "We're looking for a junior creative developer to join us at Active Theory! If you have a passion for WebGL, shaders, and making pages feel premium, reach out or apply on the job board.",
    type: "job_alert",
    likes: 88,
    commentsCount: 15,
    likedByMe: false,
  ...
  },
  {
    id: "post-12",
    authorId: "user-10",
    content: "Worked on a series of editorial vector illustrations for a tech magazine article covering digital privacy. Clean layouts, abstract shapes, and a highly selective color palette.",
  ...
  },
  {
    id: "post-13",
    authorId: "user-13",
    content: "Micro-animations make a site feel truly premium. Here is a compilation of UI animations I crafted for Duolingo last year. Keeping it lively, playful, and responsive is key!",
    type: "text",
    likes: 120,
    commentsCount: 21,
    likedByMe: false,
  ...
  },
  {
    id: "post-14",
    authorId: "user-11",
    content: "Excited to announce that DesignOS is hiring a senior product designer to lead our brand new editor interface team! If you love crafting premium workspaces, let's talk.",
    type: "job_alert",
    likes: 94,
    commentsCount: 11,
    likedByMe: false,
