    ...
    <div className="min-h-screen bg-[#030303] text-foreground grid-bg relative flex flex-col justify-between overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full glass-nav px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-primary to-accent text-white font-black shadow-lg shadow-primary/20 group-hover:scale-105 transition-transform duration-300">
            CH
          </div>
          <div>
      ...
      <section className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto pt-20 pb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20 w-full sm:w-auto">
          <Link
            href="/dashboard"
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-primary hover:bg-primary/95 text-xs font-bold text-white transition-all shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:scale-[1.02]"
          >
